import {
  ...
  wrappingInputRule
} from "./chunk-GGG4LQTJ.js";
import {
  Plugin,
  PluginKey
} from "./chunk-7NXTWHXN.js";
import {
  require_react_dom
...
function useEditorState(options) {
  const [editorInstance] = (0, import_react.useState)(() => makeEditorStateInstance(options.editor));
...
function useEditor(options = {}, deps = []) {
  ...
  const [editor, setEditor] = (0, import_react.useState)(() => {
    if (options.immediatelyRender === void 0) {
      if (isSSR || isNext) {
        if (isDev) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    if (!editorInstance) {
      editorInstance = new Editor2(options);
  ...
  const { onBeforeCreate, onBlur, onCreate: onCreate2, onDestroy: onDestroy2, onFocus, onSelectionUpdate, onTransaction, onUpdate, onContentError } = options;
  ...
  const onContentErrorRef = (0, import_react.useRef)(onContentError);
  (0, import_react.useEffect)(() => {
    if (!editor) {
      return;
    }
