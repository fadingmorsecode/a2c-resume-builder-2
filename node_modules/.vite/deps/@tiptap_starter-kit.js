import {
  BulletList
} from "./chunk-DATYIAYZ.js";
import {
  ListItem
} from "./chunk-HG3OUZ4A.js";
import {
  Decoration,
  DecorationSet,
  Extension,
    ...
    return {
      toggleOrderedList: () => ({ commands, chain }) => {
        if (this.options.keepAttributes) {
          return chain().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(ListItem2.name, this.editor.getAttributes(TextStyle.name)).run();
        }
